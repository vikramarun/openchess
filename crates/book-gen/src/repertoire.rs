...
pub const LINES: &[(&str, &str)] = &[
    ...
    (
        "Sicilian, Classical",
        "e4 c5 Nf3 d6 d4 cxd4 Nxd4 Nf6 Nc3 Nc6 Bg5 e6 Qd2 Be7 O-O-O O-O",
    ),
    (
        "Sicilian, Scheveningen",
        "e4 c5 Nf3 d6 d4 cxd4 Nxd4 Nf6 Nc3 e6 Be2 Be7 O-O O-O",
    ),
    (
        "Sicilian, Sveshnikov",
    ...
    (
        "Sicilian, Taimanov",
        "e4 c5 Nf3 e6 d4 cxd4 Nxd4 Nc6 Nc3 Qc7 Be3 a6 Bd3 Nf6",
    ),
    (
        "Sicilian, Kan",
    ...
    (
        "Sicilian, Rossolimo",
        "e4 c5 Nf3 Nc6 Bb5 g6 O-O Bg7 Re1 Nf6 c3 O-O",
    ),
    (
        "Sicilian, Moscow",
        "e4 c5 Nf3 d6 Bb5+ Bd7 Bxd7+ Qxd7 O-O Nc6 c3 Nf6 Re1 e6",
    ),
    (
        "Sicilian, Alapin",
    ...
    (
        "Sicilian, Closed",
        "e4 c5 Nc3 Nc6 g3 g6 Bg2 Bg7 d3 d6 f4 Nf6",
    ),
    ...
    (
        ...
        "e4 e6 d4 d5 Nd2 c5 exd5 Qxd5 Ngf3 cxd4 Bc4 Qd6",
    ),
    ...
    (
        "QGD, Exchange",
        "d4 d5 c4 e6 Nc3 Nf6 cxd5 exd5 Bg5 Be7 e3 c6 Bd3 O-O",
    ),
    (
        "Tarrasch Defence",
    ...
    (
        "English, Symmetrical",
        "c4 c5 Nf3 Nf6 Nc3 Nc6 d4 cxd4 Nxd4 e6 g3 Qb6",
    ),
    (
    ...
    (
        ...
        "c4 e5 Nc3 Nf6 Nf3 Nc6 e3 Bb4 Qc2 O-O",
    ),
