...
/** Icon links to the project's public accounts. Icon-only, so each link carries
 *  its own accessible name — and `title` gives the same thing to a sighted user
        ...
        >
          {GLYPHS[s.id] ? (
            <svg viewBox="0 0 24 24" width="18" height="18" aria-hidden="true" focusable="false">
              <path fill="currentColor" d={GLYPHS[s.id]} />
            </svg>
          ) : (
            s.label
          )}
